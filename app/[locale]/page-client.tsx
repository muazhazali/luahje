...
export default function PageClient() {
  ...
  const processedMessages = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      filtered = filtered.filter(
        (m) => m.to.toLowerCase().includes(q) || m.message.toLowerCase().includes(q)
      )
    }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SubmitModal open={submitOpen} onOpenChange={setSubmitOpen} onSubmit={handleSubmit} />
      ...
      <MessageDetail message={selectedMessage} open={detailOpen} onOpenChange={setDetailOpen} />
